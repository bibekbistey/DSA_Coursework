...
public class TargetedWord {
    ...
    void searching(String[] mainArray) {
        ...
        for (int j = 0; j < mainArray.length; j++) {
            ...
            // stores each word/ element of the main array 
            word = mainArray[j];
            ...
            for (int k = 0; k < mainArray[j].length(); k++) {
                ...
                // stores each letter of the word 
    ...
    int countLen(String[] actualSubSet) {
        ...
        for (int i = 0; i < actualSubSet.length; i++) {
            ...
            // compares it is either the element is null or not, if element(true) then, count it
